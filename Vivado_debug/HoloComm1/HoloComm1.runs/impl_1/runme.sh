...
HD_PWD='D:/Robot_Surveillance_V3/Software/Vivado_debug/HoloComm1/HoloComm1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log HoloComm1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source HoloComm1.tcl -notrace
