set overlay_name "zyboz7"
set design_name "zyboz7"

# open block design
open_project ./${overlay_name}/${overlay_name}.xpr
open_bd_design ./${overlay_name}/${overlay_name}.srcs/sources_1/bd/${design_name}/${design_name}.bd

# block design layout, stop_gui after generate xsa
start_gui
write_bd_layout -format pdf -orientation landscape -force ./bd_layout.pdf
